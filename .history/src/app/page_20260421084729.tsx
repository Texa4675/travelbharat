...
export default function Home() {
  ...
  const heroImages = [
    ...
    <img src="/delhi.jpg" alt="delhil"></img>,
    <img src="/mp.jpg" alt="madya"></img>,
    <img src="/taj.jpg" alt="mahal"></img>,
    <img src="/train.jpg" alt="railway"></img>,
    <img src="/desert.jpg" alt="thar"></img>,
  ];
